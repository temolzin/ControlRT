package vista;
/**
 * Esta Clase es una vista que muestra la bitacora del alumno en el inicio de sesión del Asesor Academico.
...
public class BitacoraAcademico extends JFrame {
	private JTextField textBuscarAlumnoAca;
	private JTable tableMostrarAlumnoAca;
	...
	public JButton btnBuscarAlumnoAca;
	private char letras;
	private int hacer;
	private int saber;
	private int ser;
	...
	public BitacoraAcademico() {
		...
		mnIncio.setIcon(new ImageIcon(BitacoraAcademico.class.getResource("/imagenes/inicio.png")));
		mnIncio.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				SocketLogin.vistaAsesorAca.setVisible(true);
				BitacoraAcademico.this.dispose();
			}
		});
		menuBar.add(mnIncio);
		
		JMenu mnBuscarAlumno = new JMenu("Alumno");
		mnBuscarAlumno.setIcon(new ImageIcon(BitacoraAcademico.class.getResource("/imagenes/alumno.png")));
		...
		mntmVerBtacora.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				BitacoraAcademico a = new BitacoraAcademico();
				a.setVisible(true);
				BitacoraAcademico.this.dispose();
			}
		});
		...
		mntmVerBtacora.setIcon(new ImageIcon(BitacoraAcademico.class.getResource("/imagenes/bitacora.png")));
		mnBuscarAlumno.add(mntmVerBtacora);
		
		JMenuItem mntmObservacionesYCalificaciones = new JMenuItem("Observaciones y calificaciones");
		mntmObservacionesYCalificaciones.setIcon(new ImageIcon(BitacoraAcademico.class.getResource("/imagenes/Clipboard-Paste-icon.png")));
		mntmObservacionesYCalificaciones.addActionListener(new ActionListener() {
			@SuppressWarnings("unused")
			public void actionPerformed(ActionEvent e) {
				SocketObservacionesAsesorAcaConsultarAlumno observacion = new SocketObservacionesAsesorAcaConsultarAlumno();
				BitacoraAcademico.this.dispose();
			}
		});
		...
		mnNewMenu.setIcon(new ImageIcon(BitacoraAcademico.class.getResource("/imagenes/opciones.png")));
		...
		mntmCerrarSesion.setIcon(new ImageIcon(BitacoraAcademico.class.getResource("/imagenes/cerrar.png")));
		...
		mntmCambiarContrasea.setIcon(new ImageIcon(BitacoraAcademico.class.getResource("/imagenes/cambiar.png")));
		...
		label.setIcon(new ImageIcon(BitacoraAcademico.class.getResource("/imagenes/Uttec.jpg")));
		label.setBounds(10, 11, 328, 117);
		getContentPane().add(label);
		
		JLabel lblIcono = new JLabel("");
		lblIcono.setIcon(new ImageIcon(BitacoraAcademico.class.getResource("/imagenes/logo.png")));
		...
		textBuscarAlumnoAca.setFont(new Font("Arial", Font.PLAIN, 15));
		textBuscarAlumnoAca.setBounds(619, 77, 228, 27);
		getContentPane().add(textBuscarAlumnoAca);
		textBuscarAlumnoAca.setColumns(10);
		
		btnBuscarAlumnoAca = new JButton("");
		btnBuscarAlumnoAca.setBackground(new Color(0, 102, 153));
		btnBuscarAlumnoAca.setIcon(new ImageIcon(BitacoraAcademico.class.getResource("/imagenes/buscar.png")));
		btnBuscarAlumnoAca.setBounds(857, 60, 65, 55);
		getContentPane().add(btnBuscarAlumnoAca);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(36, 122, 1310, 100);
		getContentPane().add(scrollPane);
		
		tableMostrarAlumnoAca = new JTable();
		tableMostrarAlumnoAca.setModel(new DefaultTableModel(
			new Object[][] {
			},
			new String[] {
		...
		tableMostrarAlumnoAca.setFont(new Font("Tahoma", Font.PLAIN, 12));
		scrollPane.setViewportView(tableMostrarAlumnoAca);
		...
		scrollPane_3.setBounds(485, 276, 428, 67);
		getContentPane().add(scrollPane_3);
		
		textAreaObservacionesIndu = new JTextArea();
		scrollPane_3.setViewportView(textAreaObservacionesIndu);
		...
		scrollPane_4.setBounds(934, 276, 412, 67);
		getContentPane().add(scrollPane_4);
		
		textAreaAvancesAlum = new JTextArea();
		scrollPane_4.setViewportView(textAreaAvancesAlum);
	...
	public JTable getTableMostrarAlumnoAca() {
		return tableMostrarAlumnoAca;
	}

	public void setTableMostrarAlumnoAca(JTable tableMostrarAlumnoAca) {
		this.tableMostrarAlumnoAca = tableMostrarAlumnoAca;
	}
	...
	public void promedioAcademico() {
		if (!this.textEvaluacionAca1.getText().isEmpty() && !this.textEvaluacionAca2.getText().isEmpty() && !this.textEvaluacionAca3.getText().isEmpty()) {
