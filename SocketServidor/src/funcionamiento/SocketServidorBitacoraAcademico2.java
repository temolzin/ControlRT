...
/**
 * Clase que hace la consulta a la base de datos con los datos de la bitacora.
...
public class SocketServidorBitacoraAcademico2 implements Runnable {
	...
	public SocketServidorBitacoraAcademico2() {
	...
	public void run() {
		try {
			...
			this.servidor = new ServerSocket(5022, 50);
			...
			Main.vistaServer.setTextArea("Error en SocketServidorBitacoraAcademico2 ClassNot: " + e.getMessage() + "\n");
		} catch (IOException e) {
			Main.vistaServer.setTextArea("Error en SocketServidorBitacoraAcademico2 IOException: " + e.getMessage() + "\n");
		}
	}
	/**
	 * Metodo que consulta los datos de la bitacora en la base de datos, y se los envia al cliente.
	 */
	private void consultarBitacora() {
		try {
			...
			Main.vistaServer.setTextArea("Error en SocketServidorBitacoraAcademico2 SQLException: " + e.getMessage() + "\n");
		} catch (IOException e) {
			Main.vistaServer.setTextArea("Error en SocketServidorBitacoraAcademico2: " + e.getMessage() + "\n");
		} catch (ClassNotFoundException e) {
			Main.vistaServer.setTextArea("Error en SocketServidorBitacoraAcademico2: " + e.getMessage() + "\n");
		}
	}
